...
def trigger_single_detail_dag(**context):
    ...
    try:
        ...
        airflow_client.trigger_dag(
            dag_id='instagram_article_detail',
...
def extract_and_save_article_detail(**context):
    ...
    mongo_client.upsert_many(
        collection_name='instagram_articles',
